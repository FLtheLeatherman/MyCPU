...
| multiply | **7553**          | 19185              | **11632**    | **60.63%** |
| vvadd    | **429**          | 1494              | **1065**    | **71.29%** |
...
Bypass作为五级流水的一种常用优化方式，能够有效降低计算相对密集的指令的周期数，平均能够减少占据无优化情况下总周期数50%-60%左右的bubble，但是上述计算采用的是上界，并不是实际的bubble数量，实际优化周期数可能会略小，但是Bypass优化的效果是显著的